    ...
    <div class="cat-view-content">
        ...
        <n-card ref="tableCardElRef" class="mt-sm" size="small">
            <template #header>
                <n-space>
                    <n-h3>猫咪</n-h3>
                    <n-button @click="toast('添加数据')" type="primary">
                        <g-icon :icon="SysIcons.create"></g-icon>添加
                    </n-button>
                    <n-button
                        @click="toast(`修改数据:${data.table.selectedKeys[0]}`)"
                        :disabled="data.table.selectedKeys.length !== 1"
                        type="warning"
                    >
